window.__translations_de = {
  ...
  industries: {
    ...
    items: {
      ...
      battery: {
        title: 'Battery',
        sub: 'Dryroom-Anforderungen und GMP, vom Pilot bis zur Gigafactory',
        chips: ['GMP Annex 1', 'VDI 6022', 'Dryroom'],
      },
      datacenter: {
        title: 'Datacenter',
        sub: 'Tier-III/IV-Doku, Redundanz-Konzepte und Brandschutz',
  ...
  signin: {
    title: 'Anmelden',
    sub: 'Willkommen zurück bei aynzamAI.',
    emailLabel: 'E-Mail',
  ...
  notFound: {
    ...
    description: 'Wir konnten die angeforderte Position nicht finden.',
  ...
  blog: {
    title: 'Blog',
    deck: 'Notizen aus der Praxis: Normen, Workflows und was KI im TGA-Engineering wirklich verändert.',
    readMore: 'Lesen',
    back: 'Alle Artikel',
    posts: [
      {
        tag: 'Normen',
        date: '12. August 2026',
        title: 'VDI 6022 Blatt 3: Was sich für Funktionsbeschreibungen ändert',
        excerpt:
          'Der Weißdruck bringt neue Anforderungen an Hygiene-Nachweise in der FUBE. Wir zeigen, welche Abschnitte betroffen sind.',
      },
      {
        tag: 'Workflow',
        date: '28. Juli 2026',
        title: 'Vom Anlagenschema zur Funktionsliste in vier Minuten',
        excerpt:
          'Wie die Engine Feldgeräte, Klappen und Regelkreise erkennt und daraus eine VDI-3814-konforme Funktionsliste baut.',
      },
      {
        tag: 'Vergabe',
        date: '3. Juli 2026',
        title: 'GAEB X86 ohne Nacharbeit: LV-Positionen aus Anlagedaten',
        excerpt:
          'Mengen, Einheiten und Standardtexte nach VOB/A, direkt importierbar in jedes Vergabe-Tool.',
      },
    ],
    single: {
      tag: 'Normen',
      date: '12. August 2026',
      title: 'VDI 6022 Blatt 3: Was sich für Funktionsbeschreibungen ändert',
      p1: 'Mit dem Weißdruck von VDI 6022 Blatt 3 verschieben sich die Anforderungen an Hygiene-Nachweise in der Funktionsbeschreibung. Bisher reichte ein Verweis auf die Wartungsintervalle. Jetzt müssen Reinigungs- und Inspektionspunkte je Bauteil explizit beschrieben werden.',
      h2: 'Welche Abschnitte der FUBE betroffen sind',
      p2: 'Konkret betrifft das die Kapitel Anlagenbeschreibung, Betriebsarten und Wartung. Die Engine ergänzt diese Abschnitte automatisch, sobald ein RLT-Gerät mit Hygieneanforderung erkannt wird, und verweist auf die jeweilige Tabelle der Richtlinie.',
      p3: 'Für laufende Projekte empfehlen wir, bestehende FUBEs gegen den neuen Katalog neu zu generieren. Iterationen am selben Output sind in allen Plänen unbegrenzt enthalten.',
    },
  },
