window.__translations_de = {
  ...
  hero: {
    ...
    trustLabel: 'Geprüft gegen',
    titleA: 'TGA-Doku in ',
    titleEm: 'Minuten',
    titleB: ', nicht Wochen.',
    deck: 'Funktionsbeschreibungen, Funktionslisten und Leistungsverzeichnisse, direkt aus deinen Anlagedaten. Normkonform per Default.',
  ...
  trust: {
    ...
    deck: 'Drei aktive Pilot-Engagements in Battery, Automotive und Cleanroom. Jeder Output wird gegen reale Anlagen geprüft.',
    ...
    footnote: 'Pilot-Status · seit 2025 · Referenzen auf Anfrage.',
  },
  ...
  engine: {
    ...
    deck: 'Anlagedaten gehen rein, norm-geprüfte Doku kommt raus. Drei Outputs, ein Workflow.',
    v1: {
      ...
      body: 'Vier Werte rein, vollständige Funktionsbeschreibung raus, inklusive FAT-Plan und Quellen-Nachweis.',
    },
    v2: {
      ...
      body: 'Feldgeräte und Klappen werden zur Funktionsliste nach VDI 3814, bereit für Vergabe und Inbetriebnahme.',
    },
    v3: {
      ...
      body: 'Mengen, Einheiten und Standardtexte nach VOB/A, direkt als GAEB X86 für jedes Vergabe-Tool.',
    },
  },
  ...
  useCases: {
    ...
    titleB: '.',
    deck: 'Jede Ausgabe ist normkonform, versioniert und prüfungsfähig per Default.',
    c1: {
      tag: 'Funktionsbeschreibungen',
      title: 'FUBE für jede TGA-Anlage',
      body: 'Von Lüftung bis GA-Funktion, vollständig dokumentiert inklusive FAT-Plan und Wartung.',
    },
    c2: {
      tag: 'Leistungsverzeichnisse',
      title: 'LV-Positionen nach VOB/A',
      body: 'Mengen, Einheiten und Standardtexte für die Vergabe, mit direktem GAEB-Export.',
    },
    c3: {
      tag: 'Fließmatrizen',
      title: 'Funktionsmatrizen & Schemata',
      body: 'Anlagenschemata und Funktionsmatrizen, direkt in draw.io, DWG oder PDF.',
    },
  },
  ...
  workflow: {
    ...
    titleA: 'In drei Schritten ',
    titleEm: 'zur fertigen Doku',
    titleB: '.',
    deck: 'Vom Konzept-Stand zur prüfungsfähigen Doku, ohne Copy-Paste aus Altprojekten.',
    s1: {
      label: 'Anforderung',
      title: 'Anlage beschreiben',
      body: 'Kurz beschreiben, was generiert werden soll: Komponente, Reinraum-Klasse, kritische Funktionen.',
    },
    s2: {
      label: 'Generieren',
    ...
    s3: {
      ...
      body: 'Export in dein Zielformat, versioniert, mit Audit-Trail, bereit fürs Review.',
    },
  },
  ...
  industries: {
    ...
    i1: {
      ...
      body: 'Von ISO 5 bis Subnano, FUBE für RLT, MAL, PAL und FFU in Halbleiter-Fabs.',
    },
    i2: {
      tag: 'Battery & Gigafactory',
      title: 'Dryroom & GMP',
      body: 'Trockenraum-Anforderungen und GMP-konforme Funktionsbeschreibungen, Pilot bis Gigafactory.',
    },
    i3: {
      tag: 'Mission Critical',
      title: 'HVAC für Datacenter',
      body: 'Tier-III/IV-Doku, Redundanz-Konzepte und Brandschutz für Hyperscaler.',
    },
  },
