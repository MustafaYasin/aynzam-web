window.__translations_de = {
  ...
  // ── Hero ────────────────────────────────────────────────
  hero: {
    eyebrow: 'Für TGA-Teams · Cleanroom, Battery, Datacenter',
    titleA: 'TGA-Doku in ',
    titleEm: 'Minuten',
    titleB: ', nicht Wochen.',
    deck: 'AynzamAI generiert Funktionsbeschreibungen, Leistungsverzeichnisse und Fließmatrizen für deine TGA-Projekte — geprüft gegen VDI 6022, DIN 1946-4 und GMP Annex 1.',
    ctaPrimary: 'Demo buchen',
    ctaSecondary: 'Use Cases ansehen',
    cardEyebrow: 'Was du bekommst',
    value1Strong: 'FUBE in 90 Sekunden ',
    value1Rest: '— statt 18 Tagen Excel-Iteration gegen den Norm-Katalog.',
    value2Strong: 'LV-Positionen nach VOB/A ',
    value2Rest: '— mit GAEB-X86-Export direkt für die Vergabe.',
    value3Strong: 'Fließmatrizen in draw.io ',
    value3Rest: '— importierbar in DWG, SVG und gängige TGA-Tools.',
    value4: 'Versioniert, audit-fähig, on-premise verfügbar.',
  },
